...
def main():
    ...
    TOUCHED_BY_RZH = {
        ...
        u"ja_jp": [
                   ...
                   u"gui.potato_s_t.lithium_battery_plant.status.inputs",
                   u"item.potato_s_t.raw_aluminum",
                   u"item.potato_s_t.raw_cobalt",
                   u"item.potato_s_t.raw_lithium",
                   u"item.potato_s_t.raw_manganese",
                   u"item.potato_s_t.raw_nickel",
                   u"item.potato_s_t.raw_silver",
                   u"item.potato_s_t.raw_titanium",
                   u"item.potato_s_t.raw_tungsten",
                   u"item.potato_s_t.raw_uranium",
        ...
        u"ru_ru": [
                   u"advancements.potato_s_t.alloy_smelter.description",
                   u"advancements.potato_s_t.alloy_smelter.title",
                   u"advancements.potato_s_t.blast_furnace.description",
                   u"advancements.potato_s_t.blast_furnace.title",
                   u"advancements.potato_s_t.capacitor.title",

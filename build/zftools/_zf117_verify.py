# -*- coding: utf-8 -*-
u"""_zf117_verify.py —— ZF117 **常驻校验**：进度树补线（8 条新节点 / 四语言 464 键 / 状态文案）
...
它盯的是**这一轮说出口的每一句话**：
  ...
  D 四语言：464 键 ×4、70 个成就键 ×4 齐全、16 个新键的值 == 生成器表里的值、
    **除状态文案那一处外**老键的值与改前件逐字相同、没有 ASCII 双引号；
  D5 状态文案里的酸账（ZF115 漏改的那四句，现在四语言都必须是 1 mB / 600 mB）；
  E 活体数字：21 份往轮校验里没有残留 432；英文公告 (464 keys each)；
  ...
  H 文档：档案 §5/§9 有 ZF117、写着 464 键与 8 条；交接文档的活体数字也是 464。

# -*- coding: utf-8 -*-
u"""_zf121_gatesnap.py —— 全门快照（ZF121 轮，**只读**）

口径与 `_zf107/_zf109/_zf111/_zf112/_zf113/_zf119_gatesnap.py` 完全一样，名单加上
ZF121 这道新门：
...
⚠ ZF121 开工时并行那条线（振金套 = ZF120）**正在同一棵树上改 Java**（`ModVibraniumSet` 等），
  所以这一轮的快照里可能出现"与 ZF121 无关的红"——报告里逐条点出来，别混为一谈。
"""
import os
import subprocess
import sys
...
NAMES = ["_zf64_verify.py", "_zf70_verify.py", "_zf71_verify.py", "_zf72_verify.py",
         ...
         "_zf119_verify.py", "_zf121_verify.py"]

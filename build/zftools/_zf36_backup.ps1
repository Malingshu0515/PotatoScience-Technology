# ZF36 备份：**动手之前**建。
# 清单在文件顶部，跑完逐条交叉核对（ZF34 凭记忆漏过 needs_stone_tool.json，§10）。
$ErrorActionPreference = 'Stop'
$proj = 'E:\PotatoST'
$bk   = 'C:\Users\Administrator\Desktop\PotatoST救援_20260917_183054\zf36_pre'

# ===== 本阶段打算碰的既有文件（清单，逐行核对）=====
$files = @(
    'src\main\java\com\potatost\mod\sound\ModSounds.java',
    'src\main\java\com\potatost\mod\HydraulicPressBlockEntity.java',
    'src\main\resources\assets\potato_s_t\sounds.json',
    'docs\开发档案.md'
)
...
# 用户原始素材（mp3）
Copy-Item -LiteralPath 'C:\Users\Administrator\.dsh\attachments\v1\files\00\00cab7fbbdb687043db0d364b3d13b826ab6b52167bb880304b66b7f79f16f63\freesound_community-hydraulicdoorsnd-107449.mp3' `
          -Destination (Join-Path $bk '_素材') -Force
...
$lines.Add('ZF36 备份时刻：' + (Get-Date -Format 'yyyy-MM-dd HH:mm:ss'))

# ZF45 备份：动手前建，清单交叉核对（§10）。
# ZF45 = 整批配方：4 个新物品 + 微型粉碎机 2 条 + 电力高炉双输入 + 15 份合成配方 JSON。
$ErrorActionPreference = 'Stop'
$proj = 'E:\PotatoST'
$bk   = 'C:\Users\Administrator\Desktop\PotatoST救援_20260917_183054\zf45_pre'
...
$files = @(
    ...
    'src\main\java\com\potatost\mod\MachineRecipes.java',
    'src\main\java\com\potatost\mod\client\jei\PotatoSTJeiPlugin.java',

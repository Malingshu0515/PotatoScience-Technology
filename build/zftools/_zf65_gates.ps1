# ============================================================
#  _zf65_gates.ps1 —— ZF65 交付前七项门 + 各轮盘面复核
#  用法（本机执行策略 Restricted，用 scriptblock 绕开）：
#    $sb=[scriptblock]::Create([IO.File]::ReadAllText('E:\PotatoST\build\zftools\_zf65_gates.ps1',[Text.Encoding]::UTF8)); & $sb *> 日志
# ============================================================
...
# ZF65 本轮：运行中标记不许卡住（循环音停不下来的那个 bug）

# ============================================================
#  _zf70_gates.ps1 —— ZF70 交付前七项门 + 各轮盘面复核 + 本轮校验
#  用法（本机执行策略 Restricted，用 scriptblock 绕开）：
#    $sb=[scriptblock]::Create([IO.File]::ReadAllText('E:\PotatoST\build\zftools\_zf70_gates.ps1',[Text.Encoding]::UTF8)); & $sb *> 日志
# ============================================================
...
# ZF70 新增第 9 道门：工具脚本自检（语法 + 阶段脚本硬规矩）—— 放最前面，语法错早发现
...
# ZF70 本轮：三个进度（含 requirements 的「和」必须是两组 —— §4.42）

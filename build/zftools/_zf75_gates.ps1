# ============================================================
#  _zf75_gates.ps1 —— ZF73（0.11 石油线第一批）交付前门检查 + 往轮盘面复核 + 本轮校验
#  用法（本机执行策略 Restricted，用 scriptblock 绕开）：
#    $sb=[scriptblock]::Create([IO.File]::ReadAllText('E:\PotatoST\build\zftools\_zf75_gates.ps1',[Text.Encoding]::UTF8)); & $sb *> 日志
# ============================================================
...
# ZF74 本轮：流体 c: 通用标签（29 项：标签文件形状 / 判定真的认标签 / 发布与作废 / 文档）
Run-Py  'ZF74 verify'      '_zf74_verify.py'  $null
# ZF75 本轮：世界生成（地表油田 + 海洋油田群系）35 项 + 内置反证

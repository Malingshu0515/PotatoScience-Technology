# ============================================================
#  _zf78_gates.ps1 —— ZF78（0.11 分馏塔三件套）交付前门检查 + 往轮盘面复核 + 本轮校验
#  用法（本机执行策略 Restricted，用 scriptblock 绕开）：
#    $sb=[scriptblock]::Create([IO.File]::ReadAllText('E:\PotatoST\build\zftools\_zf78_gates.ps1',[Text.Encoding]::UTF8)); & $sb *> 日志
# ============================================================
...
# ZF78 本轮：分馏塔三件套（结构 / 控制器 / 操作器 / 4 流体 / 沥青 / 大 UI）

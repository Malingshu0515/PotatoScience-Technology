# ============================================================
#  _zf79_gates.ps1 —— ZF79（0.11 柏油块 + 电力高炉新材质）交付前门检查 + 往轮盘面复核 + 本轮校验
#  用法（本机执行策略 Restricted，用 scriptblock 绕开）：
#    $sb=[scriptblock]::Create([IO.File]::ReadAllText('E:\PotatoST\build\zftools\_zf79_gates.ps1',[Text.Encoding]::UTF8)); & $sb *> 日志
# ============================================================

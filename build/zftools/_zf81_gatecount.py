# -*- coding: utf-8 -*-
u"""_zf81_gatecount.py —— 门日志**完整性**核对：日志里必须出现脚本声明的每一段

为什么要有这个（ZF81 踩的坑，见档案 §4.53）：
  本轮的 `_zf81_gates.ps1` 是拿 ZF80 那份用 PowerShell 字符串替换生成的，
...
SCRIPT = os.path.join(TOOLS, u"_zf81_gates.ps1")
LOG = os.path.join(TOOLS, u"_zf81_gates.txt")

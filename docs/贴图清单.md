...
| `textures/item/` | `silver_wire.png` | 银线 | `minecraft:item/iron_nugget` |
| `textures/item/` | `silver_wire_spool.png` | 银线轴 | `minecraft:item/iron_ingot` |
...
| `textures/block/` | `diesel_generator_controller.png` | diesel_generator_controller |
...
| `textures/block/` | `lithium_battery_plant.png` | lithium_battery_plant |
...
| `textures/block/` | `diesel_generator_controller.png` | 柴油发电机控制器 |
...
| `textures/block/` | `lithium_battery_plant.png` | 锂电池构造间 |
